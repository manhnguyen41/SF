        ...
        for pat in "${PATCH[@]}"; do
          for gsmap in "${GSMAP_TIME_STEPS[@]}"; do
            for ecmwf in "${ECMWF_TIME_STEPS[@]}"; do
              ...
              --height 19 \
              --width 35 \
              --data_idx_dir /mnt/disk3/tunm/Subseasonal_Forecasting/data3/data6789_reg_2_seed52_new_short \
              ...
              --processed_ecmwf_dir /mnt/disk3/longnd/env_data/grid_base/data3_reg_2_new_short \
