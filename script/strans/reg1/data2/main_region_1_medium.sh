...
for bs in "${BATCH_SIZES[@]}"; do
  for dr in "${DROPOUT_RATES[@]}"; do
    for lr in "${LEARNING_RATES[@]}"; do
        ...
        --height 17 \
        --width 17 \
        --data_idx_dir /mnt/disk3/tunm/Subseasonal_Forecasting/data2/data6789_reg_1_seed52_new_medium \
        ...
        --processed_ecmwf_dir /mnt/disk3/longnd/env_data/grid_base/data2_reg_1_new_medium \
        --lat_start 22.75 \
        --lon_start 102.75 \
        --use_layer_norm \
        --loss_func mae \
        ...
        --group_name data2-r1-test-vit-tiny-short-medium \
        --batch_size "$bs" \
