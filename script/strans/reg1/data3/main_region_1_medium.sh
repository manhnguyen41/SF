LEARNING_RATES=(1e-3 5e-4 2e-4 1e-4 5e-5) # 1e-3 5e-4 2e-4 1e-4 5e-5 2e-5 1e-5 5e-6 2e-6
DROPOUT_RATES=(0.30)
BATCH_SIZES=(64)
NUMBLOCK=(2)
PATCH=(3)
    ...
    for lr in "${LEARNING_RATES[@]}"; do
      for block in "${NUMBLOCK[@]}"; do
        for pat in "${PATCH[@]}"; do
          ...
          --height 17 \
          --width 17 \
          --data_idx_dir /mnt/disk3/tunm/Subseasonal_Forecasting/data3/data6789_reg_1_seed52_new_medium \
          ...
          --processed_ecmwf_dir /mnt/disk3/longnd/env_data/grid_base/data3_reg_1_new_medium \
          ...
          --group_name data3-r1-test-vit-tiny-medium \
          --batch_size "$bs" \
          --num_epochs 1000\
          --patch_size "$pat" \
          --output_norm \
